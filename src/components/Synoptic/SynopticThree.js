  ...
  return (
    <div style={main}>
      ...
      <div style={customStyle_1}>
        <h1>Tarea</h1>
        <p style={center}>
          TAREA: Luego de leer los MÓDULOS I y II, responder el siguiente
          cuestionario. <br />
          <b>IMPORTANTE: sólo se permite enviarla una sola vez.</b>{" "}
        </p>
        <iframe
          src="https://docs.google.com/forms/d/e/1FAIpQLSeO0EZFGiWof-66uZUfhl_eKczvoK0d4-hzwxu4bH4yMmT4jQ/viewform?embedded=true"
          width="340"
            height="1376"
            frameborder="0"
            marginheight="0"
