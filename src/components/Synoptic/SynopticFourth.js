        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Videoclase 1</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/svgo7o8xR0E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <h1>Videoclase 2</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/kkdsOVhnzjk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>          
                </div>
            </div>
        </div>
    );
