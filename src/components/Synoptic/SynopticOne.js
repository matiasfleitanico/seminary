    ...
    <div style={main}>
      <div style={sidebar}>
        ...
        <a style={box} href="/evangeliossinopticos/4">
          <div style={button}>
            <h2 style={span_1}>Video-Clase 1</h2>
          </div>
        </a>
        ...
        <a style={box} href="/evangeliossinopticos/6">
          <div style={button}>
            <h2 style={span_1}>Video-Clase 1 y 2 </h2>
          </div>
        </a>
        <a style={box} href="/evangeliossinopticos/7">
          <div style={button}>
          <h2 style={span_1}>Video-Clase 2 </h2>
          </div>
        </a>
      ...
      <div style={customStyle_1}>
          ...
          <h1>Evangelios sinópticos y cristología</h1>
          <p style={center}>
            Un recorrido desde la relación de similitud y diferencia, entre
            Mateo, Marcos y Lucas, analizando el aporte particular que cada uno
            suma a la PERSPECTIVA general de todo el relato en su conjunto,
            teniendo como clave interpretativa la naturaleza de JESUCRISTO, el
            Mesías. Y, un profundo análisis de los patrones de diseño que
            indican el perfil y huella de la vida de Jesús en los escritos.{" "}
