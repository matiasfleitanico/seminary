        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Videoclase 7</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/dvI2R6-BnK8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  
                    <h1>Videoclase 8</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/MPcKnLvBN_A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>        
                </div>
            </div>
        </div>
    );
