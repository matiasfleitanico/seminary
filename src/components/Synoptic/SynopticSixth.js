        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Videoclase 5</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/in45ckYZGkE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  
                    <h1>Videoclase 6</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/URPxu-Y2N1g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>         
                </div>
            </div>
        </div>
    );
