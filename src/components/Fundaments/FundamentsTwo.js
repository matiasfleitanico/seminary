    ...
    return (
      ...
      <div style={sidebar}>
        ...
        <div style={customStyle}>
                ...
                <div style={content}>
                    <a style={boxes} href="https://drive.google.com/file/d/1TZ9w5Xx-OixfxqqLrlhuc26FRUj34s3x/view?usp=drive_link" download>            
                        <h2>Módulo 1</h2>
                        <img style={img} src={"https://i.imgur.com/cJ4UvSR.jpg"}></img>
                    </a>
                    <a style={boxes} href="https://drive.google.com/file/d/1LbPunMXbLOMWsmDoBTfn82MlCCwhcQpl/view?usp=drive_link" download>            
                        <h2>Módulo 2</h2>
                        <img style={img} src={"https://i.imgur.com/SwPdQqO.jpg"}></img>
                    </a>
                </div>
                <h2>Lecturas complementarias</h2>
        <a style={boxes} href="https://drive.google.com/file/d/1Vw7EmKgZEFRYJ6932bEFCtvUW9cFQxJx/view?usp=drive_link" download>            
