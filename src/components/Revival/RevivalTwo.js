    ...
    return (
      ...
      <div style={sidebar}>
        ...
        <a style={box} href="/avivamiento/7">
          <div style={button}>
            <h2 style={span_1}>Video-Clase 5 - 6</h2>
          </div>
        </a>
        ...
        <div style={customStyle}>
                ...
                <div style={content}>
                    <a style={boxes} href="https://drive.google.com/file/d/176NwulN8C8rlk_zUB9Vme4aP1bkscxDW/view" download>            
                        <h2>Módulo 1</h2>
                        <img style={img} src={"https://i.imgur.com/cJ4UvSR.jpg"}></img>
                    </a>
                    <a style={boxes} href="https://drive.google.com/file/d/1mTToO6xkpBBsGw9JjlUo9ZfvVEfrVEEH/view" download>            
                        <h2>Módulo 2</h2>
                        <img style={img} src={"https://i.imgur.com/SwPdQqO.jpg"}></img>
                    </a>
                </div>
                <h2>Lecturas complementarias</h2>
        <a style={boxes} href="https://drive.google.com/file/d/1yJLRk39muwyOzh8XdcVrnd7zPNUIQEMk/view" download>            
                <h2>Libro - Manantiales</h2>
        </a>
            </div>
        <div style={sidebar_2}>
