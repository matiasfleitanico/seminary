...
export  default function Identidad() {
    ...
    <div style={content}>
        <a style={boxes} href="https://drive.google.com/file/d/1RTAWXIuU4_C0agP5xZ4kKtJWLRfBDJWz/view" download>            
            <h2>Módulo 1</h2>
            <img style={img} src={"https://i.imgur.com/cJ4UvSR.jpg"}></img>
        </a>
        <a style={boxes} href="https://drive.google.com/file/d/1FEDvzUT7GctKb4MUxdQw3MAqFyu2MZHl/view" download>            
            <h2>Módulo 2</h2>
            <img style={img} src={"https://i.imgur.com/SwPdQqO.jpg"}></img>
        </a>
    </div>
        <h2>Lecturas complementarias</h2>
        <a style={boxes} href="https://drive.google.com/file/d/1v7e9492nT5jqD_imZ-lmact378crEuSz/view" download>            
                <h2>Biografía de Esdras</h2>
        </a>
        <a style={boxes} href="https://drive.google.com/file/d/17YhlvszxB3Dy2PQ8HBzXvbS3A2FLzZU3/view" download>            
            <h2>Significado de CONSAGRAR</h2>
        </a>
        <a style={boxes} href="https://drive.google.com/file/d/1qOxuLv7tymtwme5FAAZI1Pqu2l6AxBHa/view" download>            
