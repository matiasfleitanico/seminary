        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Videoclase</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/8QqtcQYSJtk" title="YouTube video player" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;" autoplay={1}></iframe>
                </div>
            </div>
        </div>
    );
