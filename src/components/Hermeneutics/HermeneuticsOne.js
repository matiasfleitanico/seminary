  ...
  return (
    <div style={main}>
      ...
      <div style={customStyle_1}>
          ...
          <h1>Hermenéutica</h1>
          <p style={center}>
          Las actitudes, principios, métodos y reglas para resolver los problemas que surgen al leer e interpretar la Biblia. Y, una actualización completísima en el uso de los recursos de las nuevas tecnologías y la conectividad para el manejo de softwares que interactúan con distintas versiones de biblias, comentarios y diccionarios.  <br /> <br /> <br /> POLÍTICA DE PRIVACIDAD Todo el
