    ...
    return (
        <div style={main}>
            ...
            <div style={customStyle}>
                ...
                <div style={content}>
                    <a style={boxes} href="https://drive.google.com/file/d/1AdOyIPO_ROZ3TyMuK5RNNrCmYptZiBlM/view" download>            
                        <h2>Módulo 1</h2>
                        <img style={img} src={"https://i.imgur.com/cJ4UvSR.jpg"}></img>
                    </a>
                    <a style={boxes} href="https://drive.google.com/file/d/1ugB5PsKwkWKxRZPfSZEBg5mVgtRrx7l6/view" download>            
                        <h2>Módulo 2</h2>
                        <img style={img} src={"https://i.imgur.com/SwPdQqO.jpg"}></img>
                    </a>
                </div>
                <h2>Lecturas complementarias</h2>
        <a style={boxes} href="https://drive.google.com/file/d/1kBe_Xxt2C4_kMv0ttJ4b8omZszVD1Km8/view" download>            
