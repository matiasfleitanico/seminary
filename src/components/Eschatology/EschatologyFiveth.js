    ...
    <div style={main}>
      <div style={sidebar}>
        <a style={box} href="/escatologia/1">
          <div style={button_pressed}>
            <span style={span_2} class="material-symbols-outlined">
              {" "}
              home{" "}
            </span>
          </div>
      ...
      <div>
        <div style={customStyle}>
          <h1>Tarea</h1>
          <p style={center}>
            TAREA: Luego de leer los MÓDULOS 1, 2, 3, Y 4 responder el siguiente
            cuestionario. <br />
            <b>IMPORTANTE: sólo se permite enviarla una sola vez.</b>{" "}
          </p>
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScDkLQrnP5ZplMDVg00uSaZW-fR3He3Lkffw1XY5-eGlsDcNA/viewform?embedded=true" width="640" height="4050" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
        </div>
      </div>
    </div>
  );
