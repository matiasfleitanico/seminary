        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Tarea</h1>
                    <p style={center}>TAREA: Luego de leer los MÓDULOS 1, 2, 3, Y 4 responder el siguiente cuestionario. <br />
                    <b>IMPORTANTE: sólo se permite enviarla una sola vez.</b> </p>
                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdNqnpm2LxyE5HU9RD1dCHeb8QRfpcakZ3hPlbOPAMilShOEw/viewform?embedded=true" width="640" height="5058" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>          
                </div>
            </div>
        </div>
    );
