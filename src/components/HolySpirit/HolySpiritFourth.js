        ...
        <div style={main}>
            ...
            <div>
                <div style={customStyle}>
                    <h1>Videoclase I</h1>
                    <iframe width="1280" height="720" src="https://www.youtube.com/embed/LZ_KK8yUhzs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>            
                </div>
            </div>
        </div>
    );
