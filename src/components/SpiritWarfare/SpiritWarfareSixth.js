    ...
    <div style={main}>
      <div style={sidebar}>
        ...
        <a style={box} href="/oracionyguerra/3">
          <div style={button_pressed}>
            <h2 style={span_2}>Tarea I</h2>
          </div>
        </a>
        <a style={box} href="/oracionyguerra/4">
          <div style={button_pressed}>
            <h2 style={span_2}>Tarea II</h2>
          </div>
        </a>
      ...
      <div style={customStyle_1}>
        ...
        <iframe
          src="https://docs.google.com/forms/d/e/1FAIpQLSfekj9L2dpSExM6kkNmdmQ9GIZoFWBu5jSadp50lFlUma41Aw/viewform?embedded=true" 
          width="340"
          height="7139"
          frameborder="0"
          marginheight="0"
