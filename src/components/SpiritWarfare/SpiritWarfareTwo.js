    ...
    return (
      <div style={main}>
        ...
        <div style={customStyle}>
                ...
                <div style={content}>
                    <a style={boxes} href="https://drive.google.com/file/d/13fBJ49ByRaEVJlzA8KJtwUEagAZKLBAs/view" download>            
                        <h2>Módulo 1</h2>
                        <img style={img} src={"https://i.imgur.com/cJ4UvSR.jpg"}></img>
                    </a>
                    <a style={boxes} href="https://drive.google.com/file/d/1I9WKYjxFXf2kzOC7lTsrWjO91wCfOEQn/view" download>            
                        <h2>Módulo 2</h2>
                        <img style={img} src={"https://i.imgur.com/SwPdQqO.jpg"}></img>
                    </a>
                </div>
                <h2>Lecturas complementarias</h2>
        <a style={boxes} href="https://drive.google.com/file/d/1h801wn3V7z0hXyVVZ1MjWGfwfoDd7QYB/view" download>            
                <h2>Oración de Guerra</h2>
        </a>
            </div>
        <div style={sidebar_2}>
